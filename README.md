...
$$
p_k(z_{n,t,j}\mid z_{n,<t},z_{n,t,<j},I_{n,j})=\mathcal{N}\left(\mu_{k,t,j},\sigma_{k,j}^2\right),\qquad I_{n,j}=0.
$$

$$
p_k(z_{n,t,j}\mid z_{n,<t},z_{n,t,<j},I_{n,j})=\mathcal{N}\left(m_{k,j}^{\mathrm{int}},(\sigma_{k,j}^{\mathrm{int}})^2\right),\qquad I_{n,j}=1.
$$
